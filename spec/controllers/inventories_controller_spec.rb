...
describe InventoriesController do
  ...
  let(:valid_attributes) { { "item_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved inventory as @inventory" do
        ...
        post :create, {:inventory => { "item_name" => "invalid value" }}, valid_session
        assigns(:inventory).should be_a_new(Inventory)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested inventory" do
        ...
        Inventory.any_instance.should_receive(:update).with({ "item_name" => "MyString" })
        put :update, {:id => inventory.to_param, :inventory => { "item_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the inventory as @inventory" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Inventory.any_instance.stub(:save).and_return(false)
        put :update, {:id => inventory.to_param, :inventory => { "item_name" => "invalid value" }}, valid_session
        assigns(:inventory).should eq(inventory)
      end
