    ...
    $('#sign_in').click(function(e) {
      ...
      return FB.login((function(response) {
        if (response.authResponse) {
          return window.location = "/auth/facebook/callback?signed_request=" + response.authResponse.accessToken;
        }
      }), {
...
var photopile = (function() {
    ...
    // Thumbnails
    var numLayers         = 20;          // number of layers in the pile (max zindex)
    var thumbOverlap      = 200;         // overlap amount (px)
